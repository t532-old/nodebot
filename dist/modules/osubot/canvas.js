            ...
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        ...
                        path = '../data/image/' + uid + 'r.jpg';
                        _context.next = 5;
                        return _web.res.avatarQuery(uid, _fs2.default.createWriteStream('../data/image/' + uid + 'a.jpg'));

                    case 5:
                        _context.next = 7;
                        return _web.res.bgQuery(sid, _fs2.default.createWriteStream(path));
                    ...
                    case 15:
                        return _context.abrupt('return', path.split('/').slice(-1)[0]);
