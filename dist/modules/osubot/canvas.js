        ...
        return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    ...
                    case 28:
                        _context.next = 30;
                        return promisifyGM((0, _gm2.default)(dest).quality(100).gravity('Center').fill('#fff8').drawCircle(750, 250, 750, 610).fill('#fff8').drawCircle(750, 250, 750, 490).fill('#ccc8').drawCircle(750, 250, 750, 470).fill('#fff8').drawCircle(750, 250, 750, 460).tile(avatarBGDest).drawEllipse(750, 250, 210, 210, -145, -35));
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 17:
                        _context2.next = 19;
                        return promisifyGM((0, _gm2.default)(dest).quality(100).gravity('Center').crop(750, 500).fill('#fff8').drawCircle(375, 250, 375, 610).fill('#fff8').drawCircle(375, 250, 375, 490).fill('#ccc8').drawCircle(375, 250, 375, 470).fill('#fff8').drawCircle(375, 250, 375, 460).tile(avatarBGDest).drawEllipse(375, 250, 210, 210, -145, -35));
